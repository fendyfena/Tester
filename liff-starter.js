window.onload = function() {
    ...
    const defaultLiffId = "1609855635-9KvRrQaP";   // change the default LIFF value if you are not using a node server

    // DO NOT CHANGE THIS
    let myLiffId = "1609855635-9KvRrQaP";

    // if node is used, fetch the environment variable and pass it to the LIFF method
    // otherwise, pass defaultLiffId
    if (useNodeJS) {
        fetch('1609855635-9KvRrQaP')
